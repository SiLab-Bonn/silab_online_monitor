...
# test correlate_mm
    ...
    def test_equal_data(self):  # case1: m0_data == m1_data
        ...
        m0_data = np.array([(29123, 130515341L, 0x3253, 0x3258, 2, 35435470L, 555, 333L, 52171, 0),
                            (29123, 130515341L, 0x3255, 0x3260,
                             2, 35435471L, 666, 444L, 52171, 0),
                            (29123, 130515341L, 0x3253, 0x3258,
                             2, 35435472L, 555, 333L, 52171, 0),
    ...
    def test_no_common_frame(self):
        ...
        m1_data2 = np.array([(29123, 130515341L, 0x3253, 0x3258, 2, 35435468L, 555, 333L, 52171, 0),
                             (29123, 130515341L, 0x3255, 0x3260,
                              2, 35435468L, 666, 444L, 52171, 0),
                             (29123, 130515341L, 0x3253, 0x3258,
                              2, 35435469L, 555, 333L, 52171, 0),
...
# test correlate_fm
    ...
    def test_fe_trig_in_m26_range(self):
        ...
        m26_data = np.array([(29123, 130515341L, 0x3253, 0x3254, 2, 35435470L, 555, 333L, 52171, 0),
                             (29123, 130515341L, 0x3254, 0x3255,
                              2, 35435470L, 666, 444L, 52171, 0),
                             (29123, 130515341L, 0x3254, 0x3257,
                              2, 35435470L, 555, 333L, 52171, 0),
    ...
    def test_fe_trig_not_in_m26_range(self):
        ...
        m26_data = np.array([(29123, 130515341L, 0x3257, 0x3258, 2, 35435470L, 555, 333L, 52171, 0),
                             (29123, 130515341L, 0x3257, 0x3258,
                              2, 35435470L, 666, 444L, 52171, 0),
                             (29123, 130515341L, 0x3257, 0x3258,
                              2, 35435470L, 555, 333L, 52171, 0),
    ...
    def test_fe_trig_zero_in_m26_range(self):
        ...
        m26_data = np.array([(29123, 130515341L, 0x0000, 0x0001, 2, 35435470L, 555, 333L, 52171, 0),
                             (29123, 130515341L, 0x0001, 0x0001,
                              2, 35435470L, 666, 444L, 52171, 0),
                             (29123, 130515341L, 0x0001, 0x0002,
                              2, 35435470L, 555, 333L, 52171, 0),
    ...
    def test_fe_trig_out_of_m26_range(self):
        ...
        m26_data = np.array([(29123, 130515341L, 0x0000, 0x0001, 2, 35435470L, 555, 333L, 52171, 0),
                             (29123, 130515341L, 0x0001, 0x0001,
                              2, 35435470L, 666, 444L, 52171, 0),
                             (29123, 130515341L, 0x0003, 0x0005,
                              2, 35435470L, 555, 333L, 52171, 0),
    ...
    def test_fe_trig_overflow_in_m26_range(self):
        ...
        m26_data = np.array([(29123, 130515341L, 0x7FFF, 0x0001, 2, 35435470L, 555, 333L, 52171, 0),
                             (29123, 130515341L, 0x0000, 0x0001,
                              2, 35435470L, 666, 444L, 52171, 0),
                             (29123, 130515341L, 0x0001, 0x0001,
                              2, 35435470L, 555, 333L, 52171, 0),
