...
#         self.spin_box.valueChanged.connect(lambda value: self.send_command(str(value)))
        ...
        tdc_plot_widget_01.setXRange(0, 800, update=True)
        ...
        self.tdc_plot_02 = tdc_plot_widget_01.plot(np.linspace(-0.5, 4095.5, 4097), np.zeros((4096)), stepMode=True)
        tdc_plot_widget_02.showGrid(y=True)
        tdc_plot_widget_02.setXRange(0, 800, update=True)
        ...
        tdc_plot_widget_03.setXRange(0, 800, update=True)
        ...
        tdc_plot_widget_04.setXRange(0, 800, update=True)
        ...
        tdc_plot_widget_05.setXRange(0, 800, update=True)
