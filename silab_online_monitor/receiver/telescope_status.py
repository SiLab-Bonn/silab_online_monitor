...
class TelescopeStatus(Receiver):
    ...
    def setup_widgets(self, parent, name):
        ...
        green_pen = pg.PlotCurveItem() # need to create these for having same pen in legend as in plot since pg.InfiniteLine cant be put as item in LegendItem
...
#        view_current.enableAutoRange(axis= pg.ViewBox.XYAxes, enable=True)
        ...
        self.maxima = {'m26_c': self.m26_c_max, 'm26_v': self.m26_v_max, 'vdda_c': self.vdda_c_max, 'vdda_v': self.vdda_v_max, 'vddd_c': self.vddd_c_max, 'vddd_v': self.vddd_v_max}
        self.minima = {'m26_c': self.m26_c_min, 'm26_v': self.m26_v_min, 'vdda_c': self.vdda_c_min, 'vdda_v': self.vdda_v_min, 'vddd_c': self.vddd_c_min, 'vddd_v': self.vddd_v_min}
        ...
        self.QLCD_displays = {'m26_c': self.current_m26_c, 'm26_v': self.current_m26_v, 'vdda_c': self.current_vdda_c, 'vdda_v': self.current_vdda_v, 'vddd_c': self.current_vddd_c, 'vddd_v': self.current_vddd_v}
        ...
        self.min_max_table.setHorizontalHeaderLabels(['M26_voltage','M26_current','VDDA_voltage','VDDA_current','VDDD_voltage','VDDD_current'])
